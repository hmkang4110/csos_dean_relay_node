                                               ...
                                               uint8_t flags)
{
    ...
    ble_relay_send_write_to_dean(conn, BT_UUID_CHRC_DEVICE_NAME, buf, len);
                                                   ...
                                                   uint8_t flags)
{
    ...
    ble_relay_send_write_to_dean(conn, BT_UUID_CHRC_LOCATION, buf, len);
                                               ...
                                               uint8_t flags)
{
    ...
    ble_relay_send_write_to_dean(conn, BT_UUID_CHRC_FILE_TRANSFER, buf, len);
    return len;
}
void process_file_transfer_write(const void *buf, uint16_t len)
{
                                                  ...
                                                  uint8_t flags)
{
    ...
    ble_relay_send_write_to_dean(conn, BT_UUID_CHRC_GRIDEYE_PREDICTION, buf, len);
    return len;
}
